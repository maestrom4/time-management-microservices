...
- **Auth Service**: 60% complete. This component is actively under development and currently in a Work in Progress (WIP) state.  
...
- [auth-service](https://github.com/maestrom4/auth-service) [60%] WIP
